...
console.log("'Страница товаров с фильтрами (выполненно - 120) '\n'Страница корзины выбранных товаров (выполненно - 60)'\n'Модальное окно оформления(выполненно - 50)'\n'Выбранных товаров (выполненно - 50) '\n'Страница с описанием товара (выполненно - 40)'\n'Header, содержащий кол-во добавленных в корзину товаров и общую сумму покупок (выполненно - 20)'\n'Страница 404 (выполненно частично - 10)'\n'Всего баллов(300)")